            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card product-item">
                      <img src="https://github.com/Hujjat/vue-shop/blob/master/public/img/products/product1.jpg?raw=true" class="card-img-top" alt="...">
                          <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card product-item">
                      <img src="https://github.com/Hujjat/vue-shop/blob/master/public/img/products/product2.jpg?raw=true" class="card-img-top" alt="...">
                          <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card product-item">
                      <img src="https://github.com/Hujjat/vue-shop/blob/master/public/img/products/product3.jpg?raw=true" class="card-img-top" alt="...">
                          <div class="card-body">
